...
const TaskDetails = ({id}:{id:string}) => {
    const {data:task,isError,isLoading,error} = useGetTaskByIdQuery(id)

  return (
  <>
    {
        isLoading ? <div className='flex justify-center items-center'><Spin size='large' /></div> :  <div className="flex justify-center items-center">
